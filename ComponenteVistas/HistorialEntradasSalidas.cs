...
{
    public partial class HistorialEntradasSalidas : Form
    {
        Negocio neg = new Negocio();
        Imprimir imp = new Imprimir();
        Verificar ver = new Verificar();
        public HistorialEntradasSalidas()
        {
            InitializeComponent();
            neg.BaseDeDatos();
            Tablas(null);
        ...
        {
            dataGridView1.DataSource = neg.SelectDataTable("select * from HistorialEntradasSalidas " + condicion);
        }
        ...
        {
            if (imp.SetupThePrinting(printDocument1, dataGridView1, "Historial Entradas y Salidas", "Historial Entradas y Salidas"))
            {
