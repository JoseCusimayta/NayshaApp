...
{
    public partial class HistorialPrendas : Form
    {
        Negocio neg = new Negocio();
        Imprimir imp = new Imprimir();
        Verificar ver = new Verificar();
        public HistorialPrendas()
        {
            InitializeComponent();
            neg.BaseDeDatos();
            Tablas(null); 
        ...
        {
            dataGridView1.DataSource = neg.SelectDataTable("select Codigo, Prenda, Color, Talla, PxMayor as 'Por Mayor', PxMenor as 'Por Menor', Estado, FechaSistema as 'Fecha Sistema', HoraSistema as 'Hora Sistema', Accion as 'Acción', NuevoOrden as 'Nuevo Orden', AntiguoOrden as 'Antiguo Orden' from HistorialPrendas " + condicion);
        }
        ...
        private void b_prenda_Click(object sender, EventArgs e)
        {
            Tablas("where Prenda='" + tb_prenda.Text + "'");
        }
        ...
        {
            if (imp.SetupThePrinting(printDocument1, dataGridView1, "Historial Prendas", "Historial Prendas"))
            {
