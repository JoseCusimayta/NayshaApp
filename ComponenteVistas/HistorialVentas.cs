...
namespace ComponenteVistas
{
    public partial class HistorialVentas : Form
    {
        ...
        {
            dataGridView1.DataSource = neg.SelectDataTable("select * from HistorialVentas " + condicion);
        }
        ...
        {
            if (imp.SetupThePrinting(printDocument1, dataGridView1, "Historial Ventas", "Historial Ventas"))
            {
