...
{
    public partial class HistorialDatosAdministrativos : Form
    {
        Negocio neg = new Negocio();
        Imprimir imp = new Imprimir();
        Verificar ver = new Verificar();
        public HistorialDatosAdministrativos()
        {
            InitializeComponent();
            neg.BaseDeDatos();
            Tablas(null);
        ...
        {
            dataGridView1.DataSource = neg.SelectDataTable("select * from HistorialPersonalAdministrativo " + condicion);
        }
        ...
        {
            Tablas("where Tienda='" + tb_prenda.Text + "'");
        }
        ...
        {
            if (imp.SetupThePrinting(printDocument1, dataGridView1, "Historial del Personal Administrativo", "Historial del Personal Administrativo"))
            {
