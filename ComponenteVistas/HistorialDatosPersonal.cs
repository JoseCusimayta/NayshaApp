...
{
    public partial class HistorialDatosPersonal : Form
    {
        Negocio neg = new Negocio();
        Imprimir imp = new Imprimir();
        Verificar ver = new Verificar();
        public HistorialDatosPersonal()
        {
            InitializeComponent();
            neg.BaseDeDatos();
            Tablas(null);
        ...
        {
            dataGridView1.DataSource = neg.SelectDataTable("select * from HistorialDatosPersonal " + condicion);
        }
        ...
        {
            if (imp.SetupThePrinting(printDocument1, dataGridView1, "Historial del Personal", "Historial del Personal"))
            {
