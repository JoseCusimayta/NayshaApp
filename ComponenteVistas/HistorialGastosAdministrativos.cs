...
{
    public partial class HistorialGastosAdministrativos : Form
    {
        Negocio neg = new Negocio();
        Imprimir imp = new Imprimir();
        public HistorialGastosAdministrativos()
        {
            InitializeComponent();
            neg.BaseDeDatos();
            Tablas(null);
        ...
        {
            dataGridView1.DataSource = neg.SelectDataTable("select * from HistorialCalculoGastos " + condicion);
        }
        ...
        {
            if (imp.SetupThePrinting(printDocument1, dataGridView1, "HistorialCalculoGastosAdministrativos", "Historial del Cálculo de Gastos Administrativos"))
            {
