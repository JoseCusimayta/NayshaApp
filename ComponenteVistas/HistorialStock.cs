...
namespace ComponenteVistas
{
    public partial class HistorialStock : Form
    {
        ...
        {
            datatablas = neg.SelectDataTable("select * from HistorialStock " + condicion);
            bool tabla;
            if (datatablas == null)
            {
                tabla = false;
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ventana.dataGridView1.DataSource = neg.SelectDataTable("select * from HistorialStock where Tienda='" + Tienda + "' and FechaInv='" + Fecha + "'");
            ventana.ShowDialog();
        }
        ...
        {
            Tablas(Busqueda +"and Tienda='" + cb_tienda.Text + "'");
        }
        private void b_codigo_Click(object sender, EventArgs e)
        {
            Tablas(Busqueda + "and Codigo='" + tb_codigo.Text + "'");
        }
        ...
        {
            Tablas(Busqueda + "and FechaInv='" + dateTimePicker1.Value.ToShortDateString() + "'");
        }
        #endregion
    }
}
